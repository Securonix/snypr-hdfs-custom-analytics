SPARK_KAFKA_VERSION=0.10 spark2-submit \
 ...
 --files ./conf/hibernate.cfg.xml,./conf/log4j.properties,./conf/log4j2.xml,./conf/customanalyzer.properties,./conf/impalaquery.properties \
 --master yarn \
 --deploy-mode cluster \
